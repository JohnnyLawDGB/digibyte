...
// Keep the default wallet fee floor aligned with default relay policy.
static_assert(DEFAULT_TRANSACTION_MINFEE == DEFAULT_MIN_RELAY_TX_FEE, "wallet minimum fee diverges from default relay fee");
