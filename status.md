...
feature_config_args.py                                 | ✓ Passed  | 24 s
...
p2p_i2p_sessions.py                                    | ✓ Passed  | 0 s
...
rpc_bind.py --nonloopback                              | ✓ Passed  | 1 s
...
wallet_reindex.py --legacy-wallet                      | ✓ Passed  | 2 s
wallet_signmessagewithaddress.py                       | ✓ Passed  | 0 s
wallet_startup.py                                      | ✓ Passed  | 1 s
...
feature_assumeutxo.py                                  | ✖ Failed  | 1 s
feature_assumevalid.py                                 | ✖ Failed  | 3 s
feature_bip68_sequence.py                              | ✖ Failed  | 0 s
feature_block.py                                       | ✖ Failed  | 0 s
feature_coinstatsindex.py                              | ✖ Failed  | 1 s
feature_csv_activation.py                              | ✖ Failed  | 1 s
feature_fastprune.py                                   | ✖ Failed  | 0 s
feature_fee_estimation.py                              | ✖ Failed  | 0 s
feature_loadblock.py                                   | ✖ Failed  | 0 s
feature_maxuploadtarget.py                             | ✖ Failed  | 0 s
feature_notifications.py                               | ✖ Failed  | 2 s
feature_nulldummy.py                                   | ✖ Failed  | 0 s
feature_rbf.py                                         | ✖ Failed  | 1 s
feature_reindex_readonly.py                            | ✖ Failed  | 1 s
feature_segwit.py --descriptors                        | ✖ Failed  | 2 s
feature_segwit.py --legacy-wallet                      | ✖ Failed  | 1 s
feature_signet.py                                      | ✖ Failed  | 1 s
feature_taproot.py                                     | ✖ Failed  | 2 s
feature_utxo_set_hash.py                               | ✖ Failed  | 0 s
feature_versionbits_warning.py                         | ✖ Failed  | 1 s
interface_digibyte_cli.py --descriptors                | ✖ Failed  | 2 s
interface_digibyte_cli.py --legacy-wallet              | ✖ Failed  | 2 s
interface_rest.py                                      | ✖ Failed  | 0 s
mempool_accept.py                                      | ✖ Failed  | 1 s
mempool_accept_wtxid.py                                | ✖ Failed  | 1 s
mempool_datacarrier.py                                 | ✖ Failed  | 1 s
mempool_dust.py                                        | ✖ Failed  | 1 s
mempool_expiry.py                                      | ✖ Failed  | 0 s
...
mempool_unbroadcast.py                                 | ✖ Failed  | 0 s
mempool_updatefromblock.py                             | ✖ Failed  | 1 s
mining_basic.py                                        | ✖ Failed  | 1 s
mining_getblocktemplate_longpoll.py                    | ✖ Failed  | 7 s
mining_prioritisetransaction.py                        | ✖ Failed  | 1 s
p2p_blocksonly.py                                      | ✖ Failed  | 0 s
p2p_compactblocks.py                                   | ✖ Failed  | 0 s
p2p_dos_header_tree.py                                 | ✖ Failed  | 60 s
p2p_eviction.py                                        | ✖ Failed  | 1 s
p2p_feefilter.py                                       | ✖ Failed  | 1 s
p2p_filter.py                                          | ✖ Failed  | 1 s
p2p_headers_sync_with_minchainwork.py                  | ✖ Failed  | 1 s
...
p2p_leak.py                                            | ✖ Failed  | 1 s
p2p_leak_tx.py                                         | ✖ Failed  | 0 s
p2p_mutated_blocks.py                                  | ✖ Failed  | 1 s
p2p_node_network_limited.py                            | ✖ Failed  | 1 s
p2p_orphan_handling.py                                 | ✖ Failed  | 0 s
p2p_permissions.py                                     | ✖ Failed  | 1 s
p2p_segwit.py                                          | ✖ Failed  | 1 s
p2p_sendheaders.py                                     | ✖ Failed  | 11 s
p2p_tx_download.py                                     | ✖ Failed  | 0 s
p2p_tx_privacy.py                                      | ✖ Failed  | 0 s
rpc_blockchain.py                                      | ✖ Failed  | 1 s
...
rpc_getblockstats.py                                   | ✖ Failed  | 0 s
rpc_invalid_address_message.py                         | ✖ Failed  | 1 s
rpc_invalidateblock.py                                 | ✖ Failed  | 1 s
rpc_mempool_info.py                                    | ✖ Failed  | 0 s
rpc_net.py                                             | ✖ Failed  | 0 s
rpc_packages.py                                        | ✖ Failed  | 1 s
rpc_psbt.py --descriptors                              | ✖ Failed  | 1 s
rpc_psbt.py --legacy-wallet                            | ✖ Failed  | 1 s
rpc_rawtransaction.py --legacy-wallet                  | ✖ Failed  | 1 s
rpc_scanblocks.py                                      | ✖ Failed  | 1 s
rpc_scantxoutset.py                                    | ✖ Failed  | 0 s
rpc_signmessagewithprivkey.py                          | ✖ Failed  | 0 s
rpc_signrawtransactionwithkey.py                       | ✖ Failed  | 1 s
rpc_txoutproof.py                                      | ✖ Failed  | 1 s
rpc_validateaddress.py                                 | ✖ Failed  | 1 s
tool_signet_miner.py --descriptors                     | ✖ Failed  | 1 s
tool_signet_miner.py --legacy-wallet                   | ✖ Failed  | 1 s
tool_wallet.py --descriptors                           | ✖ Failed  | 5 s
tool_wallet.py --legacy-wallet                         | ✖ Failed  | 1 s
wallet_abandonconflict.py --descriptors                | ✖ Failed  | 1 s
wallet_abandonconflict.py --legacy-wallet              | ✖ Failed  | 2 s
wallet_address_types.py --descriptors                  | ✖ Failed  | 3 s
wallet_address_types.py --legacy-wallet                | ✖ Failed  | 3 s
wallet_avoid_mixing_output_types.py --descriptors      | ✖ Failed  | 1 s
wallet_avoidreuse.py --descriptors                     | ✖ Failed  | 2 s
wallet_avoidreuse.py --legacy-wallet                   | ✖ Failed  | 1 s
wallet_backup.py --descriptors                         | ✖ Failed  | 4 s
wallet_backup.py --legacy-wallet                       | ✖ Failed  | 5 s
wallet_balance.py --descriptors                        | ✖ Failed  | 3 s
wallet_balance.py --legacy-wallet                      | ✖ Failed  | 3 s
wallet_basic.py --descriptors                          | ✖ Failed  | 1 s
wallet_basic.py --legacy-wallet                        | ✖ Failed  | 1 s
wallet_blank.py --legacy-wallet                        | ✖ Failed  | 1 s
wallet_bumpfee.py --descriptors                        | ✖ Failed  | 1 s
wallet_bumpfee.py --legacy-wallet                      | ✖ Failed  | 1 s
wallet_change_address.py --descriptors                 | ✖ Failed  | 2 s
wallet_change_address.py --legacy-wallet               | ✖ Failed  | 2 s
wallet_conflicts.py --descriptors                      | ✖ Failed  | 2 s
wallet_conflicts.py --legacy-wallet                    | ✖ Failed  | 2 s
wallet_create_tx.py --descriptors                      | ✖ Failed  | 1 s
wallet_create_tx.py --legacy-wallet                    | ✖ Failed  | 1 s
wallet_crosschain.py                                   | ✖ Failed  | 60 s
wallet_descriptor.py --descriptors                     | ✖ Failed  | 1 s
wallet_disable.py                                      | ✖ Failed  | 1 s
wallet_fallbackfee.py --descriptors                    | ✖ Failed  | 0 s
wallet_fallbackfee.py --legacy-wallet                  | ✖ Failed  | 1 s
wallet_fast_rescan.py --descriptors                    | ✖ Failed  | 1 s
wallet_fundrawtransaction.py --descriptors             | ✖ Failed  | 1 s
wallet_fundrawtransaction.py --legacy-wallet           | ✖ Failed  | 1 s
wallet_groups.py --descriptors                         | ✖ Failed  | 1 s
wallet_groups.py --legacy-wallet                       | ✖ Failed  | 1 s
wallet_hd.py --descriptors                             | ✖ Failed  | 0 s
wallet_hd.py --legacy-wallet                           | ✖ Failed  | 2 s
wallet_implicitsegwit.py --legacy-wallet               | ✖ Failed  | 1 s
wallet_import_rescan.py --legacy-wallet                | ✖ Failed  | 5 s
wallet_importdescriptors.py --descriptors              | ✖ Failed  | 2 s
wallet_importmulti.py --legacy-wallet                  | ✖ Failed  | 1 s
wallet_importprunedfunds.py --descriptors              | ✖ Failed  | 1 s
wallet_importprunedfunds.py --legacy-wallet            | ✖ Failed  | 1 s
wallet_keypool.py --descriptors                        | ✖ Failed  | 3 s
wallet_keypool.py --legacy-wallet                      | ✖ Failed  | 3 s
wallet_keypool_topup.py --descriptors                  | ✖ Failed  | 2 s
wallet_keypool_topup.py --legacy-wallet                | ✖ Failed  | 4 s
wallet_labels.py --descriptors                         | ✖ Failed  | 3 s
wallet_labels.py --legacy-wallet                       | ✖ Failed  | 2 s
wallet_listreceivedby.py --descriptors                 | ✖ Failed  | 1 s
wallet_listreceivedby.py --legacy-wallet               | ✖ Failed  | 1 s
wallet_listsinceblock.py --descriptors                 | ✖ Failed  | 2 s
wallet_listsinceblock.py --legacy-wallet               | ✖ Failed  | 2 s
wallet_listtransactions.py --descriptors               | ✖ Failed  | 1 s
wallet_listtransactions.py --legacy-wallet             | ✖ Failed  | 1 s
wallet_migration.py                                    | ✖ Failed  | 2 s
wallet_miniscript.py --descriptors                     | ✖ Failed  | 27 s
wallet_orphanedreward.py                               | ✖ Failed  | 2 s
wallet_reorgsrestore.py                                | ✖ Failed  | 2 s
wallet_rescan_unconfirmed.py --descriptors             | ✖ Failed  | 1 s
wallet_resendwallettransactions.py --descriptors       | ✖ Failed  | 106 s
wallet_resendwallettransactions.py --legacy-wallet     | ✖ Failed  | 89 s
wallet_send.py --descriptors                           | ✖ Failed  | 2 s
wallet_send.py --legacy-wallet                         | ✖ Failed  | 2 s
...
wallet_transactiontime_rescan.py --legacy-wallet       | ✖ Failed  | 12 s
wallet_txn_clone.py                                    | ✖ Failed  | 1 s
wallet_txn_clone.py --mineblock                        | ✖ Failed  | 1 s
wallet_txn_clone.py --segwit                           | ✖ Failed  | 2 s
wallet_txn_doublespend.py --descriptors                | ✖ Failed  | 1 s
wallet_txn_doublespend.py --legacy-wallet              | ✖ Failed  | 1 s
wallet_txn_doublespend.py --mineblock                  | ✖ Failed  | 1 s
wallet_watchonly.py --legacy-wallet                    | ✖ Failed  | 1 s
wallet_watchonly.py --usecli --legacy-wallet           | ✖ Failed  | 1 s