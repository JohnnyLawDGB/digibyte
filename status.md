...
feature_config_args.py                                 | ✓ Passed  | 23 s
...
wallet_multisig_descriptor_psbt.py --descriptors       | ✓ Passed  | 2 s
...
wallet_transactiontime_rescan.py --descriptors         | ✓ Passed  | 4 s
...
feature_loadblock.py                                   | ✖ Failed  | 1 s
...
interface_digibyte_cli.py --descriptors                | ✖ Failed  | 3 s
...
mempool_spend_coinbase.py                              | ✖ Failed  | 0 s
mempool_unbroadcast.py                                 | ✖ Failed  | 8 s
...
p2p_feefilter.py                                       | ✖ Failed  | 88 s
p2p_filter.py                                          | ✖ Failed  | 2 s
...
p2p_orphan_handling.py                                 | ✖ Failed  | 3 s
p2p_segwit.py                                          | ✖ Failed  | 10 s
...
rpc_validateaddress.py                                 | ✖ Failed  | 0 s
tool_signet_miner.py --descriptors                     | ✖ Failed  | 1 s
tool_signet_miner.py --legacy-wallet                   | ✖ Failed  | 1 s
tool_wallet.py --descriptors                           | ✖ Failed  | 7 s
tool_wallet.py --legacy-wallet                         | ✖ Failed  | 7 s
...
wallet_backup.py --legacy-wallet                       | ✖ Failed  | 4 s
...
wallet_bumpfee.py --descriptors                        | ✖ Failed  | 2 s
wallet_bumpfee.py --legacy-wallet                      | ✖ Failed  | 2 s
...
wallet_create_tx.py --descriptors                      | ✖ Failed  | 0 s
...
wallet_groups.py --descriptors                         | ✖ Failed  | 0 s
...
wallet_listreceivedby.py --descriptors                 | ✖ Failed  | 2 s
...
wallet_miniscript.py --descriptors                     | ✖ Failed  | 26 s
wallet_orphanedreward.py                               | ✖ Failed  | 2 s
wallet_reorgsrestore.py                                | ✖ Failed  | 2 s
wallet_rescan_unconfirmed.py --descriptors             | ✖ Failed  | 1 s
wallet_resendwallettransactions.py --descriptors       | ✖ Failed  | 58 s
wallet_resendwallettransactions.py --legacy-wallet     | ✖ Failed  | 106 s
...
wallet_txn_clone.py --mineblock                        | ✖ Failed  | 2 s
...
wallet_watchonly.py --legacy-wallet                    | ✖ Failed  | 2 s
wallet_watchonly.py --usecli --legacy-wallet           | ✖ Failed  | 2 s