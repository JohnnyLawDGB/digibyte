...
interface_digibyte_cli.py --descriptors                | ✓ Passed  | 9 s
interface_digibyte_cli.py --legacy-wallet              | ✓ Passed  | 10 s
...
tool_wallet.py --descriptors                           | ✓ Passed  | 8 s
tool_wallet.py --legacy-wallet                         | ✓ Passed  | 9 s
...
feature_block.py                                       | ✖ Failed  | 964 s
feature_coinstatsindex.py                              | ✖ Failed  | 2 s
feature_csv_activation.py                              | ✖ Failed  | 1 s
feature_fee_estimation.py                              | ✖ Failed  | 3 s
feature_notifications.py                               | ✖ Failed  | 1 s
feature_rbf.py                                         | ✖ Failed  | 1 s
feature_segwit.py --descriptors                        | ✖ Failed  | 1 s
feature_segwit.py --legacy-wallet                      | ✖ Failed  | 2 s
...
mempool_persist.py --descriptors                       | ✖ Failed  | 4 s
mempool_reorg.py                                       | ✖ Failed  | 2 s
mempool_sigoplimit.py                                  | ✖ Failed  | 1 s
mempool_spend_coinbase.py                              | ✖ Failed  | 1 s
mempool_unbroadcast.py                                 | ✖ Failed  | 6 s
mempool_updatefromblock.py                             | ✖ Failed  | 3 s
mining_basic.py                                        | ✖ Failed  | 0 s
mining_prioritisetransaction.py                        | ✖ Failed  | 1 s
p2p_compactblocks.py                                   | ✖ Failed  | 4 s
p2p_dos_header_tree.py                                 | ✖ Failed  | 60 s
p2p_eviction.py                                        | ✖ Failed  | 63 s
p2p_feefilter.py                                       | ✖ Failed  | 92 s
...
wallet_abandonconflict.py --legacy-wallet              | ✖ Failed  | 1 s
wallet_address_types.py --descriptors                  | ✖ Failed  | 3 s
wallet_address_types.py --legacy-wallet                | ✖ Failed  | 4 s
wallet_avoid_mixing_output_types.py --descriptors      | ✖ Failed  | 2 s
wallet_avoidreuse.py --descriptors                     | ✖ Failed  | 2 s
wallet_avoidreuse.py --legacy-wallet                   | ✖ Failed  | 3 s
wallet_backup.py --descriptors                         | ✖ Failed  | 4 s
wallet_backup.py --legacy-wallet                       | ✖ Failed  | 6 s
...
wallet_bumpfee.py --descriptors                        | ✖ Failed  | 4 s
wallet_bumpfee.py --legacy-wallet                      | ✖ Failed  | 3 s
...
wallet_hd.py --legacy-wallet                           | ✖ Failed  | 1 s
wallet_import_rescan.py --legacy-wallet                | ✖ Failed  | 12 s
wallet_importdescriptors.py --descriptors              | ✖ Failed  | 2 s
wallet_importprunedfunds.py --descriptors              | ✖ Failed  | 2 s
...
wallet_keypool_topup.py --legacy-wallet                | ✖ Failed  | 5 s
wallet_labels.py --descriptors                         | ✖ Failed  | 2 s
wallet_labels.py --legacy-wallet                       | ✖ Failed  | 3 s
wallet_listtransactions.py --legacy-wallet             | ✖ Failed  | 19 s
wallet_migration.py                                    | ✖ Failed  | 9 s
wallet_miniscript.py --descriptors                     | ✖ Failed  | 29 s
wallet_orphanedreward.py                               | ✖ Failed  | 2 s
wallet_reorgsrestore.py                                | ✖ Failed  | 2 s
wallet_rescan_unconfirmed.py --descriptors             | ✖ Failed  | 0 s
wallet_resendwallettransactions.py --descriptors       | ✖ Failed  | 82 s
wallet_resendwallettransactions.py --legacy-wallet     | ✖ Failed  | 100 s
wallet_send.py --descriptors                           | ✖ Failed  | 2 s
wallet_send.py --legacy-wallet                         | ✖ Failed  | 2 s
wallet_sendall.py --descriptors                        | ✖ Failed  | 1 s
wallet_sendall.py --legacy-wallet                      | ✖ Failed  | 2 s
...
wallet_transactiontime_rescan.py --legacy-wallet       | ✖ Failed  | 16 s
wallet_txn_clone.py                                    | ✖ Failed  | 1 s
wallet_txn_clone.py --mineblock                        | ✖ Failed  | 1 s
wallet_txn_clone.py --segwit                           | ✖ Failed  | 1 s
wallet_txn_doublespend.py --descriptors                | ✖ Failed  | 2 s
