...
class WalletSendTest(DigiByteTestFramework):
    ...
    def run_test(self):
        ...
        # Test setting explicit fee rate just below the minimum of 100 sat/vB.
        self.log.info("Explicit fee rate raises RPC error 'fee rate too low' if fee_rate of 99.999 is passed")
